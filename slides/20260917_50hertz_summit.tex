...
\author{Dr. Iegor Riepin \and Dr. Michael Lindner}

\institute[Technische Universität Berlin] % (optional, but mostly needed)
{
  \footnotesize
  ENSYS TU Berlin $|$ PyPSA Labs \\
...
\begin{frame}{}
	\begin{columns}[T,onlytextwidth]
		\begin{column}{0.67\textwidth}
			...
			\small
			\begin{itemize}
				\item \textbf{Development \& maintenance}
				\item \textbf{Support subscriptions}
				\item \textbf{Training workshops}
				\item \textbf{Modelling studies}
			\end{itemize}
		\end{column}
		\begin{column}{0.27\textwidth}
			\centering
			\vspace{0.45cm}
			\qrcode[height=3.1cm]{https://pypsalabs.org}\\[0.3cm]
