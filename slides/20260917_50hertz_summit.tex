...
\begin{frame}{What is PyPSA?}
\begin{columns}[T,onlytextwidth]
\begin{column}{0.48\textwidth}
\textbf{\Large Our research focus:}
\vspace{0.25cm}
\small
\begin{itemize}
...
\item \textcolor{tub-red}{Co-optimisation} of generation, storage, conversion and transmission\\
\hspace*{0.55cm}\textcolor{tub-red}{infrastructure}
...
\includegraphics[width=\linewidth,height=0.86\textheight,keepaspectratio]{graphics/PyPSA-Ecosystem.png}
\end{column}
\end{columns}
\end{frame}
...
\includegraphics[width=\linewidth,height=0.78\textheight,keepaspectratio]{graphics/pypsa-eur-open-data.jpg}
\end{column}
\begin{column}{0.51\textwidth}
\includegraphics[width=\linewidth,height=0.52\textheight,keepaspectratio]{graphics/nep-2023-open-data.jpg}
\vfill
\centering
\includegraphics[width=0.65\linewidth,height=0.18\textheight,keepaspectratio]{graphics/logos/mastr.png}
\end{column}
\end{columns}
...
\includegraphics[width=\linewidth,height=0.76\textheight,keepaspectratio]{graphics/hotmaps.png}
\end{column}
\begin{column}{0.30\textwidth}
\includegraphics[width=\linewidth,height=0.57\textheight,keepaspectratio]{graphics/caglayan_caverns.png}
\vfill
\includegraphics[width=\linewidth,height=0.16\textheight,keepaspectratio]{graphics/caglayan_caverns_legend.png}
\end{column}
\begin{column}{0.34\textwidth}
\includegraphics[width=\linewidth,height=0.76\textheight,keepaspectratio]{graphics/wasserstoff-kernnetz-fnb-gas.jpg}
\end{column}
\end{columns}
...
\begin{frame}{}
\frametitle{Results Spotlight: PyPSA-DE and PyPSA-Eur applications}
\begin{columns}[T,onlytextwidth]
\begin{column}{0.31\textwidth}
\includegraphics[width=\linewidth,height=0.55\textheight,keepaspectratio]{graphics/ariadne-scenarios-thumbnail.png}
\footnotesize\textbf{Ariadne scenarios}\par
\scriptsize PyPSA-DE in the model comparison for climate neutrality 2045.
\end{column}
\begin{column}{0.31\textwidth}
\includegraphics[width=\linewidth,height=0.55\textheight,keepaspectratio]{graphics/ariadne-ee2030-thumbnail.png}
\footnotesize\textbf{Ariadne EE targets 2030}\par
\scriptsize PyPSA-DE tests the system effects of lower renewable build-out.
\end{column}
\begin{column}{0.31\textwidth}
\includegraphics[width=\linewidth,height=0.55\textheight,keepaspectratio]{graphics/open-tyndp-thumbnail.png}
\footnotesize\textbf{Open-TYNDP}\par
\scriptsize Open, reproducible transmission planning built with PyPSA-Eur.
\end{column}
\end{columns}
\source{\href{https://ariadneprojekt.de/publikation/report-szenarien-zur-klimaneutralitat-2045/}{Ariadne scenarios}; \href{https://ariadneprojekt.de/publikation/report-auswirkungen-einer-anpassung-der-ausbauziele-fuer-erneuerbare-energie-fuer-das-jahr-2030/}{Ariadne EE 2030}; \href{https://open-tyndp.openenergytransition.org/}{Open-TYNDP}}
\end{frame}
